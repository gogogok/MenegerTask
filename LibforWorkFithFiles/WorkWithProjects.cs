...
namespace LibWorkWithFiles
{
    ...
    public static class WorkWithProjects
    {
            ...
            do
            {
                switch (key.KeyChar)
                {
                    ...
                    case '5':
                     ...
                     (key.Key != ConsoleKey.D4) & (key.Key != ConsoleKey.D5));
        ...
        private static void ShowStatistics(List<Project> projects)
        {
            ...
            foreach (Project project in projects)
            {
                table.AddRow(project.Name, project.TasksCount().ToString(), CountTasksDone(project).ToString(),
                    PercentCompleteProject(project).ToString());
            }
