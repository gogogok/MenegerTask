    ...
    public static string[] ForPrint(Texts text)
    {
        ...
        switch (text)
        {
            ...
            case Texts.ChoosePoint:
                str  = ["Меню ", "Выберите пункт меню", " ", "1. Ввести данные через файл", "2. Просмотреть все задачи", "3. Добавить новую задачу ", "4. Изменить статус задачи", "5. Удалить задачу по ID","6. Управление зависимостями", "7. Установить дедлайн для задачи " , "8. Выйти из программы", ""];
                return str;
